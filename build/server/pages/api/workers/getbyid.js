...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  const EmployeesByIdSchema = (0,_schemas_schema__WEBPACK_IMPORTED_MODULE_2__/* .getEmployeesByGuid */ .Ik)(req.query.guid);
  const getUserByGuidResult = await (0,_hooks_useGetData__WEBPACK_IMPORTED_MODULE_0__/* .sendData */ .$)(EmployeesByIdSchema);
  const {
    data,
    error,
    isAxiosError,
  ...
  if (!error) {
    const result = (0,_hooks_usePareser__WEBPACK_IMPORTED_MODULE_1__/* .useParser */ .S)(data);
